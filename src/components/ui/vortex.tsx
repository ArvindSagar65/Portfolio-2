...
export const Vortex = (props: VortexProps) => {
  ...
  const containerRef = useRef<HTMLDivElement>(null); // Added proper type
  ...
  // Move these inside useRef to avoid recreation on each render
  const tick = useRef(0);
  ...
  const updateParticle = (i: number, ctx: CanvasRenderingContext2D) => {
    ...
    n = noise3D.current(x * xOff, y * yOff, tick.current * zOff) * noiseSteps * TAU;
